...
**Same day, user call: music is locked to the current screen.** No lingering crossfade: on a screen change the old bed stops within ~90ms (a declick ramp, not a fade, measured fully silent at ~104ms) and the new bed ramps up in 160ms. The 500ms crossfade is gone.
